...
public class TestDistancia {
  ...
  public void setUp() {
    ...
    HashSet<Horario.Dia> _hashSet_1 = new HashSet<Horario.Dia>();
    ...
    LocalComercial _localComercial = new LocalComercial("libreria don Pepito", this.unHorario, _direccion_3, _rubro);
    ...
    LocalComercial _localComercial_1 = new LocalComercial("lo de tucu", this.unHorario, _direccion_4, _rubro_1);
