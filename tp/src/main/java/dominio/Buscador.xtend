...
public class Buscador {
	...
	def String masParecido(String str1, String str2, String str3) {
		if(Levenshtein.levenshtein(str1, str3) > Levenshtein.levenshtein(str2, str3)) str2 else str1
	}
	...
	def boolean sonParecidas(String str1, String str2) {
		...
		Levenshtein.levenshtein(str1, str2) < limitador
	 }
	...
	{
		this.separarPalabras(str1).map[Levenshtein.levenshtein(this.seleccionarLaMasParecida(it, this.separarPalabras(unPunto.listaDeTags())),it)].fold(0,[num1, num2| (num1+num2)])
	}
